...
public class TopicSixPostTestActivity extends AppCompatActivity {
    ...
    private String answer, selectedAnswer, t6PostTestTotalScore, t6PostTestTotalTime, t62Questions, t62Btn1, t62Btn2, t62Btn3, t62Btn4, t62Solutions, t62Answers;
        ...
        t6PostTestNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (currentQuestionIndex < 5) {
                    t62Questions = question.getG1PostTestQuestion(randomIndex);
                    t62Btn1 = question.getG1PostTestChoice1(randomIndex);
                    t62Btn2 = question.getG1PostTestChoice2(randomIndex);
                    t62Btn3 = question.getG1PostTestChoice3(randomIndex);
                    t62Btn4 = question.getG1PostTestChoice4(randomIndex);
                    t62Solutions = question.getG1PostTestSolution(randomIndex);
                    t62Answers = question.getG1PostTestAnswer(randomIndex);
                } else if (currentQuestionIndex >= 5 && currentQuestionIndex <= 9) {
                    t62Questions = question.getG2PostTestQuestion(randomIndex);
                    t62Btn1 = question.getG2PostTestChoice1(randomIndex);
                    t62Btn2 = question.getG2PostTestChoice2(randomIndex);
                    t62Btn3 = question.getG2PostTestChoice3(randomIndex);
                    t62Btn4 = question.getG2PostTestChoice4(randomIndex);
                    t62Solutions = question.getG2PostTestSolution(randomIndex);
                    t62Answers = question.getG2PostTestAnswer(randomIndex);
                } else if (currentQuestionIndex > 9) {
                    t62Questions = question.getG3PostTestQuestion(randomIndex);
                    t62Btn1 = question.getG3PostTestChoice1(randomIndex);
                    t62Btn2 = question.getG3PostTestChoice2(randomIndex);
                    t62Btn3 = question.getG3PostTestChoice3(randomIndex);
                    t62Btn4 = question.getG3PostTestChoice4(randomIndex);
                    t62Solutions = question.getG3PostTestSolution(randomIndex);
                    t62Answers = question.getG3PostTestAnswer(randomIndex);
                }
    ...
    private void NextQuestion() {
        ...
        if (quizLevel == 1) {
            ...
            t6PostTestQuestion.setText(question.getG1PostTestQuestion(randomIndex));
            t6PostTestOptA.setText(question.getG1PostTestChoice1(randomIndex));
            t6PostTestOptB.setText(question.getG1PostTestChoice2(randomIndex));
            t6PostTestOptC.setText(question.getG1PostTestChoice3(randomIndex));
            t6PostTestOptD.setText(question.getG1PostTestChoice4(randomIndex));
            ...
            t6PostTestQuestion.setText(question.getG2PostTestQuestion(randomIndex));
            t6PostTestOptA.setText(question.getG2PostTestChoice1(randomIndex));
            t6PostTestOptB.setText(question.getG2PostTestChoice2(randomIndex));
            t6PostTestOptC.setText(question.getG2PostTestChoice3(randomIndex));
            t6PostTestOptD.setText(question.getG2PostTestChoice4(randomIndex));
            ...
            t6PostTestQuestion.setText(question.getG3PostTestQuestion(randomIndex));
            t6PostTestOptA.setText(question.getG3PostTestChoice1(randomIndex));
            t6PostTestOptB.setText(question.getG3PostTestChoice2(randomIndex));
            t6PostTestOptC.setText(question.getG3PostTestChoice3(randomIndex));
            t6PostTestOptD.setText(question.getG3PostTestChoice4(randomIndex));
